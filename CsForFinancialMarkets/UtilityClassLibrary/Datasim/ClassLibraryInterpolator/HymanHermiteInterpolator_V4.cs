 // HymanHermiteInterpolator_V4.cs
 // 
...
public class HymanHermiteInterpolator_V4:BaseOneDimensionalInterpolator
{
     // Vectors of size n
    ...
    public override void Ini(IEnumerable<double> _xarr, IEnumerable<double> _yarr) 
    {

        n = _xarr.Count();
         // BUG FIX
        int startIndex = 1;
        xarr = new Vector<double>( _xarr.ToArray(), startIndex);
        yarr = new Vector<double>(_yarr.ToArray(), startIndex);

        init();
    
    }
    public HymanHermiteInterpolator_V4() { } // AG

    public HymanHermiteInterpolator_V4(Vector<double> abscissa, Vector<double> RHS)
    {
    ...
    public HymanHermiteInterpolator_V4(double[] abscissa, double[] RHS)
    {
